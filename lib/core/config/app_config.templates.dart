  ...
  DocumentCategory(
    ...
    types: [
      DocumentType(
        ...
        optionalFields: ['previousNotices', 'evidenceList'],
      ),
      DocumentType(
        id: 'consumer_complaint',
        ...
        optionalFields: ['complainantEmail', 'previousComplaints'],
      ),
      DocumentType(
        id: 'police_complaint',
        ...
        optionalFields: ['complainantEmail', 'evidenceList', 'witnessDetails'],
      ),
      DocumentType(
        id: 'cease_desist',
        label: 'Cease & Desist',
        ...
        optionalFields: ['previousWarnings', 'evidenceList'],
      ),
      DocumentType(
        id: 'demand_letter',
        label: 'Demand Letter',
        ...
        optionalFields: ['previousDemands', 'supportingDocuments'],
      ),
    ],
  ),
  DocumentCategory(
    ...
    types: [
      DocumentType(
        ...
        optionalFields: ['maintenanceResponsibility', 'specialClauses'],
      ),
      DocumentType(
        ...
        optionalFields: ['deliverables', 'milestones'],
      ),
      DocumentType(
        ...
        optionalFields: ['exceptions', 'returnOfMaterials'],
      ),
      DocumentType(
        ...
        optionalFields: ['benefits', 'probationPeriod', 'nonCompeteClause'],
      ),
      DocumentType(
  ...
  DocumentCategory(
    ...
    types: [
      ...
      DocumentType(
        id: 'appeal_letter',
        label: 'Appeal Letter',
        description: 'Appeal against a court order or authority decision',
        promptHint: 'Appellant, respondent, order being challenged, grounds of appeal, relief sought',
        requiredFields: [
          'appellantName',
          'respondentName',
          'courtName',
        ...
        optionalFields: [
          ...
          'orderDetails',
          'supportingDocuments',
          'limitationDelayInformation',
          'prayer',
          'place',
          'date',
          'advocateOrAppellantDetails',
        ],
      ),
    ],
  ),
  DocumentCategory(
    ...
    types: [
      DocumentType(
        ...
        promptHint: 'Testator details, beneficiaries, assets, executor, specific wishes',
        requiredFields: [
          'testatorName',
          'testatorAddress',
      ...
      DocumentType(
        ...
        promptHint: 'Principal, agent/attorney, powers granted, purpose, duration',
        requiredFields: [
          'principalName',
          'principalAddress',
          'agentName',
      ...
      DocumentType(
        ...
        promptHint: 'Donor, donee, relationship, property description, witnesses',
        requiredFields: [
          'donorName',
          'donorAddress',
          'doneeName',
      ...
      DocumentType(
        ...
        description: 'Give up rights in inherited or co-owned property',
        promptHint: 'Grantor, beneficiary, property, rights relinquished, voluntary declaration',
        requiredFields: [
          'grantorName',
          'grantorAddress',
          'beneficiaryName',
  ...
  DocumentCategory(
    ...
    types: [
      DocumentType(
        ...
        promptHint: 'Employee, company, position, last working day, notice period',
        requiredFields: [
          'employeeName',
          'employeeAddress',
          'companyName',
      ...
      DocumentType(
        ...
        description: 'Formal letter terminating an employee',
        promptHint: 'Company, employee, designation, termination date, reason, final settlement',
        requiredFields: [
          'companyName',
          'companyAddress',
          'employeeName',
      ...
      DocumentType(
        ...
        promptHint: 'Company, employee, designation, employment period, performance',
        requiredFields: [
          'companyName',
          'companyAddress',
          'employeeName',
      ...
      DocumentType(
        ...
        promptHint: 'Company, candidate, job title, work location, employment type, joining date, salary',
        requiredFields: [
          'companyName',
          'companyAddress',
          'candidateName',
